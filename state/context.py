...
class GraphState(TypedDict):
    ...
    - V10 additions:
      ...
      - router_decision: {path, report, parameters, confidence, reasoning}
        set by harness_entrypoint before pipeline.invoke.
      - idre_api_response: raw IDRE API body when path==known.
    ...
    router_decision: Dict[str, Any]   # {path, report?, parameters?, confidence, reasoning}
    idre_api_response: Dict[str, Any] # Raw response when known-report path used
